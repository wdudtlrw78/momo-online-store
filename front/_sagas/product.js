...
// // function GetProductsLandingAPI(data) {
// //   return axios.post(`${PRODUCT_SERVER}/${data.gender}`, data);
// // }

// // function* getProductsLanding(action) {
// //   try {
// //     const result = yield call(GetProductsLandingAPI, action.data);
...
// // function* watchGetProductsLanding() {
// //   yield takeLatest(GET_PRODUCTS_REQUEST, getProductsLanding);
// // }

// export default function* productSaga() {
//   yield all([fork(watchUploadImages), fork(watchStorageProduct)]);
// }

// // fork(watchGetProductsLanding)
